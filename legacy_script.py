...
def run_compare(input_cbb_url: str) -> dict:
    ...
    import json
    def _b64(path):  # helper
        return base64.b64encode(open(path, "rb").read()).decode()

    text_report = open("comp_output.txt", encoding="utf-8").read()
    images = [
        _b64("input_vs_comp_radar.png"),
        _b64("nba_floor_comp_ceiling_radar.png"),
        _b64("nba_comp_vs_pred_radar.png"),
    ]
    return {"text": text_report, "imgs": images}
